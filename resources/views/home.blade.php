                                ...
                                <table class="table align-middle table-nowrap mb-0">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td>1</td>
                                            <td>lo</td>
                                            <td>{{$data['network_info']['lo']['data_sent']}} KB</td>
                                            <td>{{$data['network_info']['lo']['data_received']}} KB</td>
                                        </tr>
                                        <tr>
                                            <td>2</td>
                                            <td>eth0</td>
                                            <td>{{$data['network_info']['eth0']['data_sent']}} KB</td>
                                            <td>{{$data['network_info']['eth0']['data_received']}} KB</td>
                                        </tr>
                                        <tr>
                                            <td>3</td>
                                            <td>wlan0</td>
                                            <td>{{$data['network_info']['wlan0']['data_sent']}} KB</td>
                                            <td>{{$data['network_info']['wlan0']['data_received']}} KB</td>
                                        </tr>
                                    </tbody>
                                </table>
                            </div>
